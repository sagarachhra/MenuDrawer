...
public class LeftDrawer extends HorizontalDrawer {
  ...
  //      Toast.makeText(getContext(),"Close menu",Toast.LENGTH_SHORT).show();
    ...
    public void setiCloseKeyboard(ICloseKeyboard iCloseKeyboard) {
        this.iCloseKeyboard = iCloseKeyboard;
    }
    ...
    protected void onUpEvent(MotionEvent ev) {
        ...
        if (mIsDragging) {
        //    Toast.makeText(getContext(),"Slide Right",Toast.LENGTH_SHORT).show();
          if(iCloseKeyboard!=null)
            iCloseKeyboard.hideKeyboard();

/*
            InputMethodManager imm = (InputMethodManager)getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
            imm.hideSoftInputFromWindow(mActiveView.getWindowToken(), 0);*/
