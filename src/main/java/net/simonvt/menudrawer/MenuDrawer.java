...
public abstract class MenuDrawer extends ViewGroup {
    ...
    static ICloseKeyboard iCloseKeyboard;
    ...
    private static MenuDrawer createMenuDrawer(Activity activity, int dragMode, Position position,
        ...
        switch (position) {
            case LEFT:
                LeftDrawer leftDrawer = new LeftDrawer(activity, dragMode);
                leftDrawer.setiCloseKeyboard(iCloseKeyboard);
                return leftDrawer;
            case RIGHT:
    ...
    public interface ICloseKeyboard{
        void hideKeyboard();
    }
